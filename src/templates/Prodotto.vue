  ...
  <div class="page">
    ...
    <div class="images">
        <div class="img-container">
          <g-image v-if="$page.strapiProdotto.immagine_principale" :src="$page.strapiProdotto.immagine_principale.url" :alt="$page.strapiProdotto.codice + ' ' + $page.strapiProdotto.descrizione"/>
          <g-image v-else src="~/assets/imagenotavailable.png"></g-image>
          <hr>
        </div>
        <div v-for="img in $page.strapiProdotto.altre_immagini" :key="img.id">
          <div class="img-container">
          <g-image v-if="$page.strapiProdotto.altre_immagini" :src="img.url" :alt="$page.strapiProdotto.codice + ' ' + $page.strapiProdotto.descrizione"/>
          <g-image v-else src="~/assets/imagenotavailable.png"></g-image>
          <hr>
          </div>
        </div> 
    ...
    <div class="boxes">
      <div class="box" v-for="cat in $page.strapiProdotto.categories" :key="cat.id">
...
export default {
  ...
  methods: {
    ...
    beforeMount() {
      this.formData.message = `Vorrei avere maggiori informazioni sul prodotto con codice: ${this.$page.strapiProdotto.codice}`
    }  
}
</script>
